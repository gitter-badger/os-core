...
ifeq ($(HOST_ARCH),x86_64)
    BUSYBOX_TARGET=busybox
else
    BUSYBOX_TARGET=busybox-alternative
endif
...
busybox-alternative: Sources/busybox.config Sources/busybox
	make busybox-alternative-stamp
	-rm initrd-stamp

busybox-alternative-stamp:
	@echo "^[[1m Target busybox-alternative: Create the busybox^[[0m"
...
initrd: $(BUSYBOX_TARGET)-stamp update-stamp
	make initrd-stamp
